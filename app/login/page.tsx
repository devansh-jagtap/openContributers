  ...
  return (
    <main className="landing-shell min-h-screen flex items-center justify-center px-6">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-up">
        <div className="rounded-3xl border border-zinc-200/80 bg-white/90 p-8 shadow-[0_20px_60px_rgba(0,0,0,0.08)] backdrop-blur sm:p-10">
          ...
          <div className="mt-8 space-y-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl bg-zinc-900 px-6 py-3.5 text-sm font-medium text-white transition hover:-translate-y-0.5 hover:bg-zinc-700 active:translate-y-0"
            >
