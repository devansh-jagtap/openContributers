...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="rounded-lg border border-zinc-200 h-10 w-10 text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-300 flex items-center justify-center relative"
